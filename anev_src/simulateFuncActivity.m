function [NEVgen] = simulateFuncActivity(FN,LAGstep,LAGrem,TS,Ttrans,FG,B)
              ...
              for nbr_node = 1:N
                  ...
                  if rand(1)<FN(curr_node,nbr_node);
                      ...
                      if(new_event_time <= Bn)
                          ...
                          NEVgen(new_event_node,new_event_time) = ...
                              1;
