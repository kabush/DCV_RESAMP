function run_generate(experiment_id, Nsamples, anev_params, dcv_params,class_params)
 
    for s=1:Nsamples
        ['Generate: ',num2str(s)]

        [results_MatGenerate] = run_MatGenerate(anev_params,dcv_params);
        
        %%Format for output to file
        anev_save = [Nsamples, anev_params.N, anev_params.TS, anev_params.FG, ...
                     anev_params.FO, anev_params.HRF_d];
